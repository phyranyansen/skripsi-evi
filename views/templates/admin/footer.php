...
<!-- SweetAlert2 -->
<script src="<?= base_url().'assets/bootstrap2/plugins/sweetalert2/sweetalert2.min.js';?>"></script>
<!-- Toastr -->
<script src="<?= base_url().'assets/bootstrap2/plugins/toastr/toastr.min.js';?>"></script>
<!-- AdminLTE App -->
<script src="<?= base_url().'assets/bootstrap2/dist/js/adminlte.min.js';?>"></script>
<!-- AdminLTE for demo purposes -->
<script src="<?= base_url().'assets/bootstrap2/dist/js/demo.js';?>"></script>
        ...
        var myLineChart = new Chart(ctx, {
            ...
            options: {
              ...
              title: {
                display: true,
                align: "start",
                text: "Grafik Radar Hasil Survey"
              },
...
<script>
  $(function () {
    ...
    $("#kom").DataTable({
      ...
      "paging"   : false,
      "buttons": [ "excel"]
    }).buttons().container().appendTo('#kom_wrapper .col-md-6:eq(0)');
    $('#example2').DataTable({
      "paging": true,
      "lengthChange": false,
      "searching": true,
